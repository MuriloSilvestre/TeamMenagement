...
@Component({
  selector: 'app-small-paginador-list',
  standalone: true,
  templateUrl: './small-paginador-list.component.html',
  styleUrls: ['./small-paginador-list.component.css'],
  imports: [CommonModule],
})
export class SmallPaginadorListComponent implements OnInit {
  @Input() lista: any[] = [];
